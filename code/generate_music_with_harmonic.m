function [t,song_data] = generate_music_with_harmonic(song_list, beat, a, b, full_harmonic_data, freq)
...
for i = 1:1:length(song_list)
    ...
    count = 1;
    lambdas = search_nearest_tune(full_harmonic_data, single_freq);
    single_song_data = 0;
    for lambda = lambdas
